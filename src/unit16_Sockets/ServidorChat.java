...
class MarcoServidorChat extends JFrame implements Runnable{
    ...
    /**
     * Método que se ejecuta cuando el hilo comienza. Este método se encarga de escuchar conexiones entrantes
     * en un puerto específico (9999), recibir mensajes de texto a través de un socket y mostrarlos en un
     * área de texto.
     * <p>
     * El método crea un {@link ServerSocket} en el puerto 9999 y entra en un bucle infinito donde acepta
     * conexiones de clientes. Para cada conexión, lee un mensaje de texto utilizando un {@link DataInputStream}
     * y lo muestra en un área de texto ({@code areatexto}). Luego, cierra el socket.
     * </p>
     * <p>
     * Si ocurre una excepción de tipo {@link IOException}, se lanza una {@link RuntimeException}.
     * </p>
     *
     * @see ServerSocket
     * @see Socket
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                //Leemos el mensaje y lo guardamos en una variable
                String mensajeTexto = flujoEntrada.readUTF();
                //Mostramos el mensaje en el area de texto
                areatexto.append( "\n" + mensajeTexto);
                miSocket.close();
            }
